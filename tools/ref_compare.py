...
CLASSES = [
    ("небо",      lambda h, s, v: 0.50 <= h <= 0.65 and s < 0.45 and v > 0.62),
    ("вода",      lambda h, s, v: 0.47 <= h <= 0.62 and s >= 0.30 and v > 0.45),
    ("трава",     lambda h, s, v: 0.20 <= h <= 0.45 and s >= 0.25),
    ("дорога",    lambda h, s, v: (h < 0.16 or h > 0.92) and s < 0.35 and v > 0.70),
    ("забудова",  lambda h, s, v: (h < 0.09 or h > 0.93) and s >= 0.35 and v > 0.25),
    ("дерево",    lambda h, s, v: 0.06 <= h <= 0.14 and s >= 0.30),
]
