...
# --- ЗАСТАРІЛО 18.09.2026 -----------------------------------------------------------------
# Цей інструмент дописував кореню чанка z_offset_m. Тепер зсув НЕ зберігається в сцені взагалі:
# його передає той, хто ставить чанк (LevelChunkLoader.offset_for → LevelTimeline.extract),
# бо цеглинку треба вміти поставити на 150-му метрі одного рівня й на 900-му іншого.
# Запускати його означає повернути прив'язку чанка до одного місця в одному рівні.
raise SystemExit(
    "tools/localize_chunk_z.py застарів: зсув більше не живе в сцені чанка.\n"
    "Див. docs/tasks/reusable-chunks.md, крок 1.")
# ------------------------------------------------------------------------------------------
