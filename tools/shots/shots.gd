...
##
## ВАЖЛИВО:
## - РУШІЙ. Знімати з `--rendering-method gl_compatibility`: так працює телефон і веб. Рушій
##   проєкту за замовчуванням — `mobile`, і 25.09 уся перевірка вигляду в ньому пройшла, а в
##   Compatibility будинки вийшли вдвічі темнішими в тіні (див. docs/MEMORY.md).
