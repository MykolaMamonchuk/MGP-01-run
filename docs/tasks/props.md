...
Типи такого декору **не змішуються вздовж однієї стрічки**: Track вибирає тип один раз на
світ. Різні типи мають різну висоту (0,26 проти 0,41 м), і вибір на кожну ланку давав би
огорожу, що стрибає вгору-вниз уздовж берега.
