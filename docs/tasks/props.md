...
**Станом на 17.09.2026 це вже неправда для першого світу:** Лужок має справжні моделі на всі
29 видів. Але решта гри — ні; точні числа по кожному світу див. «Решта гри: світи 2–5»
наприкінці файлу.
...
1. **Пляж — чи є там берег?** Світ `beach` має `"sea": true` (режим `surf`): дорога під
...
2. **Хмаринки — 78 дерев'яних поручнів у небі.** `clouds.json` описує канал
