...
| крок | що | ціна в пікселі | ефект | стан |
|---|---|---|---|---|
| 1 | Варіант A — джиттер плиток і краю | **0** | сітка перестає бути правильною | **ЗРОБЛЕНО 24.09** |
| 2 | Шум-плями із запеченої текстури (5.5) | +1 вибірка | відтінки «плавають» | чекає |
| 3 | Варіант B — атлас відтінків на плитку | +1 вибірка | кожна плитка своя | чекає |
| 4 | Варіант C — стрічка з вершинними кольорами | +2 вибірки, −13× вершин | нерівний край, зникають шви | чекає |

### Крок 1 виконано й заміряно

Джиттер плиток стоїть у `Track.tile_jitter()`: зсув, поворот і легке стискання тих самих
екземплярів MultiMesh, детерміновано від зерна ряду. **Жодної нової вершини.** Базовий
`TILE_GAP` заодно звужено з 0,02 до 0,014, бо рівний зазор і був головною причиною
«надрукованої сітки».

Заміряно на Redmi 8A, рівень 7, п'ять знімків накладки: **54,6 мс проти 54,9 до правки** —
у межах шуму. Виклики малювання й примітиви не змінились, і не могли: екземпляри ті самі.
Знімок: `shots/2026-09-24-doroha-dzhytter.png`.

Перша спроба була завелика (укорочення до 6%): зазор ріс із 2 до 8 см, і дорога почала
читатись як плити НА ТРАВІ. Тому масштаб майже не чіпаємо — він єдиний розширює шов.

### Кроки 2–4 НЕ є наступним пріоритетом

Вони про якість дороги, а не про кадр: разом вони дадуть 0 або +2 вибірки, тобто виграшу в
мілісекундах від них чекати не варто. Наступне за кадром — **декор** (~30 мс, найбільша
недоторкана стаття). До косметики дороги вертатись, лише якщо після джиттера сітка все ще
дратує на живому пристрої.
