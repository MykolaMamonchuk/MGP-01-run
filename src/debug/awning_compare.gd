...
## ПОРІВНЯННЯ ЯТОК: нинішня процедурна ятка і нові (6000/3000/1500 трикутників) — як їх малює ГРА.
## Нові — з awning_stall_1..5 (0,7-1,25 млн трикутників, docs/refs/incoming/awning), спрощені
## й перезапечені з повної моделі. Інструмент той самий, що для хати; див. house_compare.gd.
##
...
const ROWS := [
	["ЯТКА 1", [
		["У ГРІ ЗАРАЗ\n282 верш", "res://assets/props/awning_stall.glb"],
		["6000 тр\n9093 верш", "res://assets/props/_exp/awning/awning_stall_1_6000.glb"],
		["3000 тр\n5161 верш", "res://assets/props/_exp/awning/awning_stall_1_3000.glb"],
		["1500 тр\n2910 верш", "res://assets/props/_exp/awning/awning_stall_1_1500.glb"],
	]],
	["ЯТКА 2", [
		["У ГРІ ЗАРАЗ\n282 верш", "res://assets/props/awning_stall.glb"],
		["6000 тр\n7864 верш", "res://assets/props/_exp/awning/awning_stall_2_6000.glb"],
		["3000 тр\n4347 верш", "res://assets/props/_exp/awning/awning_stall_2_3000.glb"],
		["1500 тр\n2271 верш", "res://assets/props/_exp/awning/awning_stall_2_1500.glb"],
	]],
	["ЯТКА 3", [
		["У ГРІ ЗАРАЗ\n282 верш", "res://assets/props/awning_stall.glb"],
		["6000 тр\n8408 верш", "res://assets/props/_exp/awning/awning_stall_3_6000.glb"],
		["3000 тр\n4681 верш", "res://assets/props/_exp/awning/awning_stall_3_3000.glb"],
		["1500 тр\n2682 верш", "res://assets/props/_exp/awning/awning_stall_3_1500.glb"],
	]],
	["ЯТКА 4", [
		["У ГРІ ЗАРАЗ\n282 верш", "res://assets/props/awning_stall.glb"],
		["6000 тр\n9995 верш", "res://assets/props/_exp/awning/awning_stall_4_6000.glb"],
		["3000 тр\n5832 верш", "res://assets/props/_exp/awning/awning_stall_4_3000.glb"],
		["1500 тр\n3732 верш", "res://assets/props/_exp/awning/awning_stall_4_1500.glb"],
	]],
	["ЯТКА 5", [
		["У ГРІ ЗАРАЗ\n282 верш", "res://assets/props/awning_stall.glb"],
		["6000 тр\n9710 верш", "res://assets/props/_exp/awning/awning_stall_5_6000.glb"],
		["3000 тр\n5267 верш", "res://assets/props/_exp/awning/awning_stall_5_3000.glb"],
		["1500 тр\n3158 верш", "res://assets/props/_exp/awning/awning_stall_5_1500.glb"],
	]],
]
...
func _build() -> void:
	...
	($Камера as Camera3D).look_at_from_position(Vector3(0.0, 11.5, 6.5), Vector3(0, 0.0, -7.2))
	...
	for r in range(ROWS.size()):
		...
		title.position = Vector3(-(float(widest) * 0.5 + 0.4) * spacing, 0.9, z)
