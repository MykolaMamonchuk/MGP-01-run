...
const STEPS := [
	...
	{"назва": "0.6, дальність уся", "flags": ["shadows"], "scale": "60"},
	{"назва": "0.6, дальність 30 м", "flags": ["shadows", "near30"], "scale": "60"},
	{"назва": "0.6, дальність 20 м", "flags": ["shadows", "near20"], "scale": "60"},
	{"назва": "0.6, дальність 14 м", "flags": ["shadows", "near14"], "scale": "60"},
	{"назва": "0.6, кожен 8-й (для порівн.)", "flags": ["shadows", "keep8"], "scale": "60"},
	{"назва": "контроль: дальність уся", "flags": ["shadows"], "scale": "60"},
]
