...
const STEPS := [
	...
	{"назва": "як є: 5-6 матеріалів", "flags": [], "scale": "100"},
	{"назва": "один матеріал, без текстури", "flags": ["onemat"], "scale": "100"},
	{"назва": "один матеріал, З текстурою", "flags": ["onetex"], "scale": "100"},
	{"назва": "декору нема (межа)", "flags": ["decor"], "scale": "100"},
	{"назва": "контроль: як є", "flags": [], "scale": "100"},
]
