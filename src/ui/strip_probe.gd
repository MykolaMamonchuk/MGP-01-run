...
const STEPS := [
	...
	{"назва": "як зараз 1.0", "flags": [], "scale": "100"},
	{"назва": "Н1: 0.6, кожен 2-й", "flags": ["keep2"], "scale": "60"},
	{"назва": "Н2: 0.6, кожен 4-й", "flags": ["keep4"], "scale": "60"},
	{"назва": "Н3: 0.6, кожен 4-й, без тіней", "flags": ["keep4", "shadows"], "scale": "60"},
	{"назва": "Н4: 0.5, кожен 4-й, без тіней", "flags": ["keep4", "shadows"], "scale": "50"},
	{"назва": "контроль 1.0", "flags": [], "scale": "100"},
]
