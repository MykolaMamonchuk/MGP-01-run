...
## ДОСЛІД 25.09: КАРТКИ ДАЛЕКИХ ХАТ ЛІВОРУЧ.
##
## Далекі хати лівого боку (далі 10 м від осі, поворот 90°) лежать в окремих шарах
## «…#farL#wall». `farcards` малює їх плоскими картками, знятими під кутом ігрової камери;
## `nofar` ховає їх зовсім — стеля. У кадрі з тієї самої миті картки міняють лише 2-2,7%
## пікселів, а прибирання далеких хат — теж мало: ближня смуга їх здебільшого затуляє.
## Очікуваний структурний лічильник: farcards — примітиви ВНИЗ майже як у nofar (на Маку
## 172 тис. -> 144 тис. проти 141 тис.), виклики майже незмінні.
const VARIANTS := [
	{"назва": "як зараз (далекі 3D)", "flags": []},
	{"назва": "далекі ліві — картки", "flags": ["farcards"]},
	{"назва": "без далеких лівих (стеля)", "flags": ["nofar"]},
	{"назва": "контроль: як зараз", "flags": []},
]
