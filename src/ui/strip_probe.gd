...
const STEPS := [
	...
	{"назва": "усе як є @1.3", "flags": [], "scale": "130"},
	{"назва": "без забудови @1.3", "flags": ["buildings"], "scale": "130"},
	{"назва": "усе як є @2.0", "flags": [], "scale": "200"},
	{"назва": "без забудови @2.0", "flags": ["buildings"], "scale": "200"},
	{"назва": "контроль @1.3", "flags": [], "scale": "130"},
]
