...
## ДОСЛІД 24.09: скільки з 12,4 мс полотна дороги знімає ВЖЕ НАЯВНА правка. Підлога
## показала, що полотно — найбільша стаття вмісту (12,4 проти 4,3 у декору). Перш ніж
## писати суцільний меш, дивимось, що дає простіше: прибрати ОСНОВУ під плиткою й зазор
## поперек (це стиль «гладка», уже зроблений).
const VARIANTS := [
	{"назва": "усе як є", "flags": []},
	{"назва": "без основи", "flags": ["roadbase"]},
	{"назва": "без основи + зазору поперек", "flags": ["roadbase", "tilez"]},
	{"назва": "СТЕЛЯ: полотна нема зовсім", "flags": ["roadbase", "roadtiles"]},
