...
const STEPS := [
	...
	{"назва": "ВИГЛЯД: як є", "flags": [], "scale": "100"},
	{"назва": "ВИГЛЯД: без карт нормалей", "flags": ["nonormal"], "scale": "100"},
	{"назва": "ВИГЛЯД: спільний матеріал", "flags": ["onetex"], "scale": "100"},
]
