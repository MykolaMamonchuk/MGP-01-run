...
## ДОСЛІД 24.09: ВІДСІКАННЯ ДРІБНОГО ДЕКОРУ за екранним розміром. Бюджет дрібниці 4,3 мс,
## до цілі лишилось 4,1 — тож навіть частковий успіх може закрити питання. Поріг у промілях
## висоти екрана: dcull15 = 1,5%, dcull30 = 3,0%, dcull50 = 5,0%.
const VARIANTS := [
	{"назва": "усе як є", "flags": []},
	{"назва": "відсікання 1,5%", "flags": ["dcull15"]},
	{"назва": "відсікання 3,0%", "flags": ["dcull30"]},
	{"назва": "відсікання 5,0%", "flags": ["dcull50"]},
	{"назва": "дрібниці нема зовсім", "flags": ["props"]},
