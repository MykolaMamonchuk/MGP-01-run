...
const STEPS := [
	...
	{"назва": "як є: колір+норм+метал+шорст", "flags": []},
	{"назва": "без нормалей", "flags": ["nonormal"]},
	{"назва": "без нормалей і металу", "flags": ["nonormal", "nometal"]},
	{"назва": "лише колір (усе стале)", "flags": ["nonormal", "nometal", "norough", "noao"]},
	{"назва": "спільний матеріал (стеля)", "flags": ["onetex"]},
