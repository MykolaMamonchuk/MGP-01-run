...
## ДОСЛІД: ціна подвійного малювання землі НА ВЖЕ ОПТИМІЗОВАНІЙ грі (тіні вимкнені,
## туман замінено завісами). Старі 26,2/38,8 знімались із туманом — вони більше не чинні.
const VARIANTS := [
	{"назва": "усе як є", "flags": []},
	{"назва": "без основи", "flags": ["roadbase"]},
	{"назва": "без плитки", "flags": ["roadtiles"]},
	{"назва": "без основи й плитки", "flags": ["roadbase", "roadtiles"]},
