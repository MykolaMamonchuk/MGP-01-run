...
const LEAN_ROLL := 0.075           ## максимальний крен у поворот, рад
const LEAN_YAW := 0.05            ## максимальне довертання носа, рад
const FOLLOW_LAG := 0.32          ## яку частку зсуву героя камера НЕ повторює одразу
...
const FOV_PUNCH := 3.0            ## ривок поля зору на спотиканні, градуси
const FOV_EASE := 4.5
