...
## Вертикальна швидкість назовні: камері треба знати, що герой у стрибку, щоб провиснути
## під ним. Саме поле приватне, бо його виставляє фізика героя, а не хтось ззовні.
func vy() -> float:
	return _vy
