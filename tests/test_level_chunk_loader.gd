...
## чанками по порядку. Був рівень 1, але його перевели на бібліотеку цеглинок і теки в нього
## не стало; беремо наступний такий самий. Коли текою не лишиться жодного рівня, ці перевірки
